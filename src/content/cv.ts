        ...
        projects: {
            ...
            items: [
                ...
                },
                {
                    ...
                    description:
                        "Plataforma de automação comercial que monitora conversas em WhatsApp e Instagram, identifica oportunidades e dispara alertas contextuais para apoiar o atendimento e a recuperação de vendas.",
                    highlights: [
                        "Processamento de eventos e mensagens com agentes especializados para suporte, receita, leads estagnados e retenção.",
                        "Integração com WhatsApp, Instagram e APIs externas para captura de eventos e acionamento de respostas.",
                        "Dashboard operacional com inbox de alertas, métricas e acompanhamento das oportunidades identificadas.",
                        "Arquitetura orientada a eventos com processamento, SLA, agentes especializados e mecanismos de alertas.",
                    ],
                },
            ],
        },
        ...
        projects: {
            ...
            items: [
                ...
                },
                {
                    ...
                    description:
                        "Commercial automation platform that monitors WhatsApp and Instagram conversations, identifies opportunities, and triggers contextual alerts to support customer service and sales recovery.",
                    highlights: [
                        "Event and message processing with specialized agents for support, revenue, stalled leads, and retention.",
                        "Integration with WhatsApp, Instagram, and external APIs for event capture and response workflows.",
                        "Operational dashboard with alert inbox, metrics, and visibility into identified opportunities.",
                        "Event-driven architecture connecting processing, SLA management, specialized agents, and alert mechanisms.",
                    ],
                },
            ],
        },
